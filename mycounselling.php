...
<?php include('header.php'); ?>
	...
	<div class="search" style="background-color:;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">Student Details</h3>
			...
			<?php 
					...
					$sql = " SELECT * FROM studentreg WHERE contact = '" . $_POST["search"]."' OR email = '" . $_POST["search"]."' ";
