...
<!-- result -->
					...
					$sql = " SELECT * FROM counsellor WHERE address = '" . $_POST["address"]."' AND expertise = '" . $_POST["expertise"]."' ";
					...
					if($count>=1){
						...
						?>
							<td><a href="booking.php?coun_id=<?php echo $row['coun_id'] ?>">Book</a></td>;
						<?php 		
	...
	<a href="search_counsellor.php">Search Again</a></button>
