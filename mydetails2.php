...
<?php 
							include('connect.php');
							session_start();
							$sql="SELECT * FROM studentreg where email='" . $_SESSION["email"] . "'";
...
<br><br><br>
			...
			<!-- update information -->
				...
				<?php
							...
							$sql="UPDATE studentreg SET name='" .$_POST["name"]. "' ,age='" .$_POST["age"]."' , contact='" .$_POST["contact"]. "',address='" .$_POST["address"]. "', email='".$_POST["email"]."' WHERE email='" .$_SESSION["email"]. "'";
