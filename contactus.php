	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Esther Wandia <h2><h4>Studied B.Sc in Information Technology</h4>
							<h5>Pioneer University, Muranga _Road.</h5>
						<p> 
							Email:estherwandiangetha@gmail.com <br>
							cell: +254759273807</p><br>
				</article>
			</div>
			<div class="col-md-6">
