...
<head>
	...
	<title>Guidance and Counselling management system</title>
...
<div class="container-fluid">
	...
	<div class="login" style="background-color:#fff;">
		<h1 class="text-center" style="background-color:#272327;color: #fff;">Counsellor Panel</h1>
			...
			<?php 
							...
							$sql= "SELECT * FROM counsellor WHERE userid= '" . $_POST["userid"]."' AND password= '" . $_POST["password"]."'";
							...
							$result = $conn->query($sql);
									...
									if ($result->num_rows > 0) {
										    ...
										    echo "<script>location.replace('condashboard.php');</script>";
